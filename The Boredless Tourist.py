...
def get_traveler_location(traveler):
  ...
  travel_destination_index = get_destination_index(traveler_destination)
...
def get_attractions_for_the_traveler(traveler):
  traveler_destination = traveler[1]
  traveler_interests = traveler[2]
  traveler_attractions = find_attractions(traveler_destination, traveler_interests)
  interests_string = "Hi " + traveler[0] + ", we think you'll like these places around " + traveler[1] + ": " 
  for attraction in traveler_attractions:
      return interests_string +  attraction
      
print(get_attractions_for_the_traveler(['Dereck Smill', 'Paris, France', ['monument']]))